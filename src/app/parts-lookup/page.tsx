        ...
        <div className="min-h-screen bg-background text-white py-8">
            <div className="max-w-6xl mx-auto px-4">
                ...
                <motion.div className="mb-12 text-center" initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.6 }}>
                    ...
                    <h1 className="text-4xl font-bold mb-4 text-white">Parts Lookup</h1>
                    <p className="text-xl text-gray-300">Find the right parts for your equipment quickly and easily</p>
                </motion.div>
                        ...
                        <CardContent>
                            <Tabs value={activeTab} onValueChange={setActiveTab} className="w-full">
                                <TabsList className="grid w-full grid-cols-3 bg-gray-700">
                                    <TabsTrigger value="machine" className="data-[state=active]:bg-yellow-500 data-[state=active]:text-gray-900">By Machine</TabsTrigger>
                                    <TabsTrigger value="vin" className="data-[state=active]:bg-yellow-500 data-[state=active]:text-gray-900">By VIN/Serial</TabsTrigger>
                                    <TabsTrigger value="part" className="data-[state=active]:bg-yellow-500 data-[state=active]:text-gray-900">By Part Number</TabsTrigger>
                                </TabsList>
                                ...
                                <TabsContent value="machine" className="mt-6">
                                    ...
                                    <Button onClick={() => handleSearch('machine')} disabled={isSearching || !searchForm.machineModel} className="mt-4 bg-yellow-500 hover:bg-yellow-600 text-gray-900 font-bold">
                                ...
                                <TabsContent value="vin" className="mt-6">
                                    ...
                                    <Button onClick={() => handleSearch('VIN')} disabled={isSearching || !searchForm.vinNumber} className="mt-4 bg-yellow-500 hover:bg-yellow-600 text-gray-900 font-bold">
                                ...
                                <TabsContent value="part" className="mt-6">
                                    ...
                                    <Button onClick={() => handleSearch('part')} disabled={isSearching || !searchForm.partNumber} className="mt-4 bg-yellow-500 hover:bg-yellow-600 text-gray-900 font-bold">
                            ...
                            {searchResult && (
                                <motion.div className="mt-6 p-4 bg-gray-700/50 rounded-lg" initial={{ opacity: 0 }} animate={{ opacity: 1 }}>
                                    <div className="flex items-center gap-3">
                                        ...
                                        <p className="text-gray-300">{searchResult.message}</p>
                                    </div>
                                </motion.div>
                            )}
                        </CardContent>
                ...
                <motion.div className="mb-8" initial={{ opacity: 0, y: 20 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }} transition={{ duration: 0.6 }}>
                    ...
                    <div className="flex flex-wrap gap-2">
                        {popularSearches.map((term, i) => (
                            <Button key={i} variant="outline" onClick={() => handleQuickSearch(term)} className="border-yellow-500 text-yellow-500 hover:bg-yellow-500/10">
                                {term}
                            </Button>
                        ))}
                    </div>
                ...
                <div className="grid md:grid-cols-2 gap-8">
                        ...
                        <Card className="bg-gray-800 border-gray-700 h-full">
                            <CardHeader>
                                <CardTitle className="flex items-center gap-3 text-white">
                                    <FileText className="w-6 h-6 text-yellow-500" />Cross Reference
                                </CardTitle>
                            </CardHeader>
                            <CardContent className="space-y-4 text-gray-300">
                                ...
                                <Button onClick={() => router.push('/contact')} className="w-full bg-yellow-500 hover:bg-yellow-600 text-gray-900 font-bold mt-4">Request Cross Reference</Button>
                            </CardContent>
                        </Card>
                    </motion.div>
                    ...
                    <motion.div initial={{ opacity: 0, x: 20 }} whileInView={{ opacity: 1, x: 0 }} viewport={{ once: true }} transition={{ duration: 0.6, delay: 0.1 }}>
                        <Card className="bg-gray-800 border-gray-700 h-full">
                            <CardHeader>
                                <CardTitle className="flex items-center gap-3 text-white">
                                    <Phone className="w-6 h-6 text-yellow-500" />Parts Specialist
                                </CardTitle>
                            </CardHeader>
                            <CardContent className="space-y-4 text-gray-300">
                                <p>Need help finding the right part? Our parts specialists can assist you.</p>
                                <div className="space-y-2">
                                    <div className="flex items-center gap-2"><CheckCircle className="w-4 h-4 text-yellow-500" />Call: +966 57 019 6677</div>
                                    <div className="flex items-center gap-2"><CheckCircle className="w-4 h-4 text-yellow-500" />WhatsApp Available</div>
                                    <div className="flex items-center gap-2"><CheckCircle className="w-4 h-4 text-yellow-500" />Response within 2 hours</div>
                                </div>
                            </CardContent>
                        </Card>
                    </motion.div>
