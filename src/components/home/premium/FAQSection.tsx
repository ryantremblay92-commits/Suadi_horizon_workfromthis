...
export function FAQSection() {
    ...
    return (
        <section ref={containerRef} className="py-20 lg:py-28 bg-surface relative overflow-hidden">
            {/* Background Texture */}
                    ...
                    >
                        ...
                        <div className="bg-white/5 p-8 rounded-2xl border border-white/10 flex items-start gap-5">
                            ...
                            <div>
                                ...
                                <button className="text-gold font-bold text-xs uppercase tracking-widest hover:text-white transition-colors">
                                    Chat with an expert
                                </button>
                            </div>
                        </div>
